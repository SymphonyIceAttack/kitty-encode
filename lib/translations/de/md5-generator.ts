export const md5Generator = {
  ...
  "md5Generator.pageSubtitle": "Generieren Sie MD5-Hash für Textzeichenfolgen sofort",
  "md5Generator.inputLabel": "Eingabetext",
  "md5Generator.inputPlaceholder": "Geben Sie Text ein, um MD5-Hash zu generieren...",
