export const about = {
  ...
  "about.team.content":
    "Started by developers, for developers. We experienced firsthand the frustration of needing quick tools but having to install software or deal with complicated interfaces. That's why we created simple, fast, and reliable web-based tools that work instantly in your browser.",
