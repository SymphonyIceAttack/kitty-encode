export const common = {
  ...
  "common.relatedToolsDesc": "Откройте для себя больше инструментов и руководств для улучшения вашего рабочего процесса разработки",
  "common.relatedToolDesc": "Мощный инструмент для улучшения вашего рабочего процесса разработки",
