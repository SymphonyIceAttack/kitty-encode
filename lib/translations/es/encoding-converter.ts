export const encodingConverter = {
  ...
  "encodingConverter.outputPlaceholder": "El texto convertido aparecerá aquí...",
  ...
  "encodingConverter.error.invalidInput": "Entrada inválida para la codificación seleccionada",
